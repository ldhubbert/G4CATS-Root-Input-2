...
//      if (fFileGen->GetType() == B4FileGenerator::kPluto ||
//          fFileGen->GetType() == B4FileGenerator::kPlutoCocktail ||
//          fFileGen->GetType() == B4FileGenerator::kGiBUU)
      {
...
void B4PrimaryGeneratorAction::PhaseSpaceGenerator(G4Event* anEvent){
...
void B4PrimaryGeneratorAction::OverlapGenerator(G4Event* anEvent){
...
//    tree_gibuu = (TTree*)ftest->Get("RootTuple");
  ...
  if (tree_mkin)
  {
    fFileGen = new B4FileGeneratorMkin(fInFileName);
  }
//  else if (tree_pluto)
//  {
//#ifdef WITH_PLUTO
//    fFileGen = new B4FileGeneratorPluto(fInFileName);
//#else
...
//  else if (tree_gibuu)
//  {
//    fFileGen = new B4FileGeneratorGiBUU(fInFileName);
//  }
  else
  {
...
//    G4cout << "A2PrimaryGeneratorAction::SetUpFileInput(): Opening GiBUU-event file" << G4endl;
  ...
  {
//    if (fFileGen->GetType() == B4FileGenerator::kPlutoCocktail || fFileGen->GetType() == B4FileGenerator::kGiBUU)
//    {
...
void B4PrimaryGeneratorAction::SetMode(G4int mode)
{
  fMode=mode;
